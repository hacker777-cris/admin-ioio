          ...
          {loading ? (
            ...
            reports.map((report) => (
              <TableRow key={report.id}>
                ...
                <TableCell>{report.owner.username}</TableCell>
        ...
        >
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <h3 className="text-sm font-medium text-gray-500">Reported Owner</h3>
                <p className="mt-1">{selectedReport.owner.username}</p>
